...
import styles from './CadastraAniversariantesWebPart.module.scss';
...
export default class CadastraAniversariantesWebPart extends BaseClientSideWebPart<ICadastraAniversariantesWebPartProps> {
  ...
  public render(): void {
    ...
    <section class="${styles.cadastraAniversariantes} ${!!this.context.sdks.microsoftTeams ? styles.teams : ''}">
